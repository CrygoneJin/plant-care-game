...
| 2026-04-03 | S25-1: Palette als Instrument (#71) — jeder material-btn click spielt soundPaletteNote(idx) aus GENRES | Array.from statt forEach um Index zu kriegen. Dynamisch erzeugte Buttons berechnen Index per indexOf(btn) zur Laufzeit. soundBuild in dynamischem Handler entfernt — Genre-Note reicht. |
