...
| Datum | Was | Warum gut |
|-------|-----|-----------|
| 2026-04-01 | Jim Knopf Weltkarte (PR #163) — worldmap.js war fertig aber nie eingebunden | Script-Tag in index.html fehlte. Lesson: nach Erstellen einer .js immer pruefen ob der Script-Tag auch drin ist. |
