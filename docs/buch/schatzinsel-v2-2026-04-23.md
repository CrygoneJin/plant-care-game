...
untertitel: Ein Bericht aus fünf Stimmen, redigiert (v2)
autor: Schatzinsel-Kollektiv
editor: Friedrich Schiller (v2, nach Ende/Dalai/Lindgren + Oscar-Daten)
datum: 2026-04-23
version: v2
basis: docs/buch/schatzinsel-2026-04-23.md + 3 Redaktionsberichte + Oscar-Tesla-Morgen
---
...
> — Oscar, 8, am Telefon zum Vater, 2026-02
...
Die fünf Pärchen der team-dev-Zelle — eins ausführlich, damit man das Prinzip sieht, der Rest als Halbsatz:

**Jobs + Woz.** Steve Jobs sagt „Ship it." Steve Wozniak sagt „Aber hast du gesehen, was es kann?" Wozniak war der Typ, der den Apple I in der Garage tatsächlich gebaut hat, während Jobs die Vision beschrieben hat. Wozniak baut Prototypen, die keiner bestellt hat. Er zeigt sie begeistert. Jobs sagt: „Ship it oder lass es." Wozniak akzeptiert das. Beim ersten Mal. Manchmal beim zweiten. Irgendwann kommt ein Prototyp, der nicht zu ignorieren ist. Das ist das System. Ein Master mit Vision, ein Padawan mit Werkbank — und eine Reibung, aus der Produkte entstehen, die keine der beiden Stimmen allein hätte bauen können.

Die anderen vier Pärchen funktionieren nach demselben Muster, mit je eigenem Akzent: **Ogilvy + Hemingway** (eleganter Text, der vom anderen brutal gekürzt wird); **Rams + Hick** (Haltung neben Messinstrument — *Weniger, aber besser* neben der Stoppuhr); **Feynman + Popper** (didaktische Erklärung neben dem Einwurf *beweis, dass du unrecht hast*); **Torvalds + Kernighan** (Code für die Maschine neben Code für den nächsten Leser, der ihn verstehen soll).

Fünf Pärchen. Zehn Stimmen. Das ist team-dev im Normalbetrieb. Hinter jedem Master steht außerdem eine Schatten-Lehrlingin (Susan Kare, Mary Wells Lawrence, Hella Jongerius, Maryam Mirzakhani, Margaret Hamilton), die nicht aktiv produziert, sondern beobachtet — falls die Zelle sich eines Tages teilt. Aber das ist Zellbiologie mit Blick, und dieses Buch ist keine Zellbiologie.

Kein Master darf sich selbst auf ein größeres Modell elevieren. Das ist eine harte Regel. Wenn Jobs sagt „ich denke heute in Opus", sagt Feynman: „Versuch's mal mit Schlaf." Die Entscheidung trifft der externe Auditor, nicht der Auditierte. Der Grund: Agenten, die sich selbst Ressourcen zuteilen dürfen, geben sich immer mehr. Das ist keine Bosheit, das ist Optimierung für eine Zielgröße, die der Agent selbst beeinflussen kann. Also entscheidet der Messende, nicht der Gemessene.
