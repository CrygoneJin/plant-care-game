...
| Datum | Was | Warum gut |
|-------|-----|-----------|
| 2026-03-30 | 2D Emoji-Positionsgrammatik (2x2 Grid) | Rosenfeld 1979 + Chomsky-Erweiterung: 4 Positionen, 6 Relationen. 30% der NPC-Kommentare als 2x2 CSS-Grid. Kinder denken räumlich (Piaget), LTR/RTL-agnostisch. |
