...
|-------|-----|-------|---------|
| 2026-04-01 | gh CLI nicht installiert, GitHub MCP Tools nicht konfiguriert — PR kann nicht automatisch erstellt werden | Kein `gh` im PATH, keine mcp__github__ Tools | PR muss manuell auf github.com erstellt werden wenn gh fehlt |
| 2026-04-01 | game.js wächst trotz Extraktion (4649→4653) weil neue Features hinzukommen | CODE_EASTER_EGGS -58 LOC, aber S25-2+S25-3 +62 LOC | Schuldenabbau und Feature-Arbeit gegeneinander rechnen. Separate Refactor-Sprints nötig für echte LOC-Reduktion. |
