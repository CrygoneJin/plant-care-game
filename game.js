...
(function () {
    ...
    function calcCellSize() {
        ...
        if (isMobile) {
            // Canvas soll die volle Breite nutzen, Header+Toolbar+Palette abziehen (~100px)
    ...
    // ============================================================
    // === QUESTS === (aus quests.js, Fallback inline)
    // ============================================================
    ...
    const CODE_EASTER_EGGS = {
        stone: [
            ...
            '🪨 Neben C sitzt eine Frau und schreibt. "Juli Zeh?" — "Genau. Und das ist meine doppelt positiv geladene Kameradin: Zeh++!"',
            '🪨 Juli Zeh meißelt in den Stein: "Unter Leuten war ich schon. Jetzt bin ich unter Blöcken." Zeh++ ritzt daneben: "Unter Leuten++. Doppelt so gesellig!"',
            '🪨 C grinst: "Alle nennen mich C. Aber meine Freunde sagen Juli Zeh." Zeh++ verdreht die Augen: "Du machst den Witz JEDES MAL."',
        ],
        tree: [
        ...
        flower: [
            ...
            '💎 Ruby findet alles hier gut. Der fährt auf Schienen zur Railway. "Bin deployed!", ruft er. "Aber Übersee. Ganz andere Umgebung da drüben."',
            '💎 "In meiner Production-Umgebung sieht alles anders aus", seufzt Ruby. "Hier ist Development. Stationiert bin ich woanders. Andere Env halt."',
            '💎 Ruby zeigt seine Railway-Fahrkarte: "Auf Schienen. Übersee. Andere Umgebung." Rust grunzt: "Bei MIR läuft alles LOKAL. Rustikal eben."',
        ...
        boat: [
            ...
            '🦀 "Hier hat keiner den Black Belt", sagt Rust. "Hier hat man den RUST Belt. Rustikal eben."',
            '🦀 Rust poliert sein Zahnrad: "Memory-safe! Keine Pointer-Probleme wie bei der Zeh!" Juli Zeh ruft rüber: "ICH HAB MEINE POINTER ABGEGEBEN!"',
            '🦀 "Im Rust Belt trägt man keinen Gürtel", erklärt Rust. "Man trägt Ownership. Und Borrowing. Rustikal eben."',
        ],
        fence: [
        ...
        bridge: [
            ...
            '🌉 "Es gibt zwei Arten von Architekten", sagt Juli Zeh. "Die einen bauen Häuser. Die anderen bauen die Sprache, in der man Häuser beschreibt."',
        ],
        water: [
            '☕ Das Wasser dampft! "Auf der Insel Java wird viel Kaffee getrunken", murmelt Juli Zeh.',
            '🦈 Im Wasser schwimmt ein Schatten! "MAKRO!" ruft Juli Zeh. "Der böse Hai! Er frisst alles und macht es RIESIG!"',
        ...
        mushroom: [
            ...
            '🍄 "Was hat Hirnfitz gesagt?" fragt Python. "Ich glaube: Hallo." — "Dafür braucht er 100 Zeichen?!" — Juli Zeh',
        ],
        lamp: [
            '💡 Die Lampe flackert. In der Birne steht winzig: "Powered by JavaScript".',
            '💡 "Wusstest du: JavaScript wurde in 10 Tagen erfunden? Auf einer Insel!" — Zeh++',
        ...
        cactus: [
            ...
            '🦜 Fortran flattert auf: "Seit ich bei Vortran in Rente bin, nehm ich\'s mit den strikten Dingen nicht mehr so genau!" *krächz*',
            '🦜 "Früher war ich STRIKT! Jetzt lass ich mich gehen!" Fortran guckt auf seine Flügel. "Pointer? Die hab ich ABGEGEBEN! Zeig ich halt nicht mehr. Fort-ran die Disziplin!"',
    ...
    const HOERSPIELE = {
        ...
        fiftyBlocks: [
            ...
            '🪨 C: "...definiere besser."',
            '🪨 Juli Zeh nickt: "Unter Leuten war das nix. Unter Blöcken: Literatur!"',
            '🦀 Rust: "50 Blöcke und kein einziger Memory Leak. Rustikal, aber sicher."',
        ],
        hundredBlocks: [
        ...
        halfIsland: [
            ...
            '🪨 C: "Ohne MICH gäbe es euch alle nicht." Juli Zeh: "Ohne mich keine Romane. Zeh++: Und keine Fortsetzungen!"',
        ...
        fullIsland: [
            ...
            '🪨 C: "Ich erinnere mich an den Tag als hier NICHTS war." Juli Zeh: "Ich auch. Ich hab darüber geschrieben."',
