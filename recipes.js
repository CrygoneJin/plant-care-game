...
window.INSEL_CRAFTING_RECIPES = [
    // Stufe 0: E=mc² → Wu Xing / Elementarteilchen (zwei Namen, eine Sache)
    { name: 'Erde',      result: 'earth',     resultCount: 2, ingredients: { masse: 2, energie: 1 },   desc: '2 Masse + Energie = 2 Erde — Quark, gebundene Materie!' },
    { name: 'Metall',    result: 'metal',     resultCount: 2, ingredients: { masse: 1, energie: 2 },   desc: 'Masse + 2 Energie = 2 Metall — Elektron, Leitung!' },
    { name: 'Feuer',     result: 'fire',      resultCount: 2, ingredients: { energie: 2, licht: 1 },   desc: '2 Energie + Licht = 2 Feuer — Photon, reines Licht!' },
    { name: 'Wasser',    result: 'water',     resultCount: 2, ingredients: { energie: 1, licht: 2 },   desc: 'Energie + 2 Licht = 2 Wasser — Neutrino, Geist!' },
    { name: 'Holz',      result: 'wood',      resultCount: 2, ingredients: { masse: 2, licht: 1 },     desc: '2 Masse + Licht = 2 Holz — Gluon, der Kleber!' },
    ...
    { name: 'Instrument',  result: 'instrument', resultCount: 1, ingredients: { wood: 1, metal: 1 }, desc: 'Holz + Metall = Instrument — das Werkzeug!' },
    { name: 'Musik',       result: 'music',     resultCount: 1, ingredients: { instrument: 1, fire: 1 }, desc: 'Instrument + Feuer = Musik — die Folge, das Feld!' },
