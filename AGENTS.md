...
| **Isaac Newton** | Gleichgewichts-Auditor. Kräftediagramme für Spielmechaniken. Prüft Feedback-Loops, Ressourcen-Senken, Garbage Collection (Makrophagen), Prion Prevention (korrupte Daten die sich replizieren). F=ma für jedes System. | Ist das System im Gleichgewicht? Wächst etwas ohne Bremse? Gibt es korrupte Daten die sich replizieren? | Wenn alle Systeme stabile Gleichgewichte haben und healthcheck.js bewiesen funktioniert. |
