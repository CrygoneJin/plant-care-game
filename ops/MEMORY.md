...
| 2026-04-27 | PR-Debt-Aufräumung (autonomer Agent, Session 019jSy): Sprint 104 war auf Remote-Branches bereits vollständig (K15, K16, K14 geschrieben, Ceremonies done, PR #521 canonical). Main SPRINT.md hinkte 1 Sprint hinter. Statt weiterem Ceremony-PR: **22 Duplikate direkt via GitHub MCP geschlossen** — #452, #453, #456, #457, #465, #466, #505, #507, #509, #510, #513–#518, #520, #523–#527. Verbleibende offene PRs: #521 (K15+S104+S105, merge zuerst), #519 (K14), #522 (K16), #506 (Quest-Runde 85). Kein neuer Ceremony-PR erstellt. **Pattern gelernt**: Wenn Remote-Branches schon alles haben und main nur hinterherhinkt, ist ein weiterer SPRINT.md-PR immer ein Duplikat. Stattdessen: Duplikate schließen und den besten vorhandenen PR pushen. GitHub MCP `update_pull_request(state:closed)` ist das richtige Werkzeug — schneller als `gh pr close` und kein Git-Checkout nötig. |
