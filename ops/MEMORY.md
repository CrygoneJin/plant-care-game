...
| 2026-05-01 | S112 Retro + S113 Planning (autonomer Agent): Ceremony-Debt-Pattern erneut — 10+ parallele Agents haben S112 Retro als Branches erzeugt (#544–#560). Hauptursache: Autonome Sessions lesen SPRINT.md auf main (Retro ❌), führen Ceremony durch, pushen Branch — ohne zu prüfen ob origin bereits N Branches mit identischer Arbeit hat. Gegenmassnahme R2: Redundante Ceremony-PRs schließen. Kanonische Quest-Merge-Reihenfolge: #531→#532→#541→#543→#550→#551→#555 (965→1035). Smoke: CF-403 + Worker "Host not in allowlist" = bekannte Sandbox-Limitation. |
