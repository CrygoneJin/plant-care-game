...
| 2026-04-20 | Session 92 (Daily Scrum S89): Remote Branch hatte bereits Runde 69 aus Nacht-Session implementiert. Doppelte Quests lokal erstellt → via git reset --hard zurückgesetzt. Lesson: Immer zuerst `git fetch` + Remote-History prüfen bevor neu implementiert wird. PR #384 offen (706 Quests). |
...
| 2026-04-19 | Nach Konsolidierungs-PR #381 alle NPCs auf 52 Quests — Retro-Notizen mit alten Counts (34 für Tommy/Bug/Bernd) veraltet | Retro vor dem Merge geschrieben, nicht danach | NPC-Counts nach jedem Konsolidierungs-PR neu zählen bevor Sprint-Planung. S89 korrekt mit Tommy/Bug/Bernd gestartet. PR #384. |
