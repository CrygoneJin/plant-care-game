...
| 2026-04-21 | Session 102 — Daily Scrum S92: Quests Runde 76 implementiert. Floriane (+4, 60→64), Mephisto (+3, 61→64), Kraemerin (+3, 62→65). 775→785 Quests. PR #401, conflict-free mit allen offenen PRs (#394–#399). PR #398 geschlossen (obsolet durch #400). Merge-Reihenfolge für Till: #394→#395→#396→#397→#399→#401 → 835 Quests. Smoke-Test 403 ist bekannte Sandbox-Einschränkung. |
...
| 2026-04-21 | SPRINT.md auf main war 2 Sprints (S90+S91) hinter der Realität — autonome Sessions hatten es nur auf feat-Branches aktualisiert, nicht auf main | Docs-PRs für SPRINT.md wurden nicht gemergt, main blieb bei S89 | SPRINT.md direkt auf main-Branch committen (via neuer docs-Branch + PR), nicht nur auf feat-Branches. |
| 2026-04-21 | Runde 75 conflict-free mit R73/R74 durch NPC-Trennung: R73=Krabs/Bug/Tommy, R74=Maus/Neinhorn/Spongebob → R75=Alien/Elefant/Lokführer | Konflikte entstehen durch gleiche NPCs in parallelen Branches | Vor jeder Quest-Runde: offene PR NPC-Liste prüfen, komplett andere NPCs wählen. |
