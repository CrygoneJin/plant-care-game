...
| 2026-05-03 | S115 Session (autonomer Agent): **Counter-Fehler korrigiert** — S114 plante Tommy(74)/Bernd(74) als S115-Kandidaten, aber `grep -o "npc: '[^']*'" quests.js \| sort \| uniq -c \| sort -rn` zeigt krabs(73)/floriane(73)/elefant(73) als niedrigste. PR #605 (feat/sprint-115-correct) hat korrekte NPCs: krabs(73→77)/floriane(73→76)/elefant(73→76), 965→975. **Merge-Reihenfolge für Till: PR #592 (S113) → PR #604 (S114) → PR #605 (S115)**. Nach Vollmerge: 995 Quests, niedrigste Counter tommy/bernd/mephisto(74). S116 = tommy(74)/bernd(74)/mephisto(74). **Pflicht-Learning**: NPC-Counter IMMER via `grep quests.js` messen — nie aus SPRINT.md-Summaries planen (die propagieren Fehler). |
| 2026-05-03 | S114 Sprint Planning (autonomer Agent): Quest-Runde 96 implementiert — maus(72→76 +4)/kraemerin(72→75 +3)/bug(72→75 +3), 965→975 Quests. PR #604 offen. Maus-Highlights: Eratosthenes mit Stöcken gegen die Unwissenheit, Regentropfen als Grand-Canyon-Miniatur-Baumeister. Kraemerin: Salär kommt von Salz. Bug-Trias: alle drei zeigen kollektive Intelligenz ohne Anführer (Bienen-Tanz, Ameisen-Floß, Schmetterling-Erbgedächtnis). PR #531 (S113) bleibt dirty — Rebase-Signing-Fehler in Worktree, GitHub-UI "Update branch" löst es. **Merge-Reihenfolge**: #531 zuerst, dann #604. ~~S115: Tommy(74)/Bernd(74)~~ → Counter-Fehler, siehe S115-Eintrag. |
