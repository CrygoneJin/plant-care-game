...
| 2026-04-29 | S117 Review + Retro + S118 Planning + Quest-Runde 100 (autonomer Agent, Branch feat/sprint-118): Sprint 117 vollständig (1/1 ✅). Quest-Runde 100 Meilenstein: Maus(72→76 +4)/Kraemerin(72→75 +3)/Bug(72→75 +3), 975→985 Quests. Themen: Maus "Was man findet wenn man wartet" (Mondlicht/Warte-Garten/Fundstücke/Begegnungs-Laube) — pieps/quak-Stimme; Krämerin "Geben ohne Rechnung" (Gratis-Tee/Saatgut-Tausch/Jahresfest) — herzlich-praktische Stimme; Bug "Was Insekten ohne Plan bauen" (Termiten/Bienen-Tanzsprache/Ameisenstraßen) — 🦋-Observationsstil. NPC-Counter-Drift-Problem bestätigt: ops-Branch hatte Mephisto(74) als Startpunkt, feat-Branch hatte 71 — immer feat-Branch zählen. tsc grün, 985 Quests verified. |
...
| 2026-04-29 | S117 Runde 99: Neinhorn(71→75)/Mephisto(71→74)/Spongebob(72→75) +10 Quests (965→975) — NPC-Counter immer aus quests.js auf main zählen (grep -c), nicht aus Branch-Notizen. ops/sprint-s117-planning hatte falsche Counter (74/75/75 statt tatsächlich 71/71/72) weil es von main-Stand ausging der Intermediate-Branches nicht berücksichtigt. | PR #550 feat/sprint-117 |
