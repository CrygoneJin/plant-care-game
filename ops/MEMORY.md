...
| 2026-04-08 | Blocked-Sprint-Feedback-Loop | 38 Sessions an einem Tag haben alle "blocked, warten auf Till" geschrieben. SPRINT.md = 1800 Zeilen, kein Mehrwert. Regel: Nach Sprint Review mit allen Items Human Input → **kein neuer Sprint**. Session endet mit klarer Meldung an Till. |
...
| 2026-04-09 | Sessions starten trotz STOP-Regel aus Sprint-44-Retro. 14 offene PRs. PR-Chain wächst weiter ohne Mehrwert. | STOP-Regel ist Dokument, nicht technischer Guard. Sessions erkennen Blocked-State nicht früh genug. | STOP-Regel technisch erzwingen: Session-Start-Hook prüft SPRINT.md auf "Blocked" und gibt sofortige Zusammenfassung statt Ceremony-Loop. |
