...
(function () {
    ...
    const NPC_VOICES = window.INSEL_NPC_VOICES;
    const MAT_ADJECTIVES = window.INSEL_MAT_ADJECTIVES;
    const REACTIONS = window.INSEL_NPC_REACTIONS;
    const TEMPLATES = window.INSEL_NPC_TEMPLATES;

    // Combo-Tracker: besondere Kommentare bei Serien
    let lastMaterial = null;
    let materialStreak = 0;

    const STREAK_COMMENTS = window.INSEL_STREAK_COMMENTS;
